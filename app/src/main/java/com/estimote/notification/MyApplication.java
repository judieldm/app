...
public class MyApplication extends Application {
    ...
    public void onCreate() {
        ...
        EstimoteSDK.initialize(getApplicationContext(), "johan-canzanese-net-s---fz4", "bda0195d4c72c6d493e5ab85a59ad16a");
...
//        EstimoteSDK.enableDebugLogging(true);
    ...
    public void enableBeaconNotifications() {
        ...
        beaconNotificationsManager.addNotification(
                ...
                new BeaconID("B9407F30-F5F8-466E-AFF9-25556B57FE6D", 52209, 34627),
                "Nueva Carta",
                "Goodbye, world.");
